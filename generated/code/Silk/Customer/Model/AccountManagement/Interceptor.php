<?php
namespace Silk\Customer\Model\AccountManagement;

/**
 * Interceptor class for @see \Silk\Customer\Model\AccountManagement
 */
class Interceptor extends \Silk\Customer\Model\AccountManagement implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'changePasswordForOldCustomer');
        if (!$pluginInfo) {
            return parent::changePasswordForOldCustomer($customer, $newPassword);
        } else {
            return $this->___callPlugins('changePasswordForOldCustomer', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'validateOldPassword');
        if (!$pluginInfo) {
            return parent::validateOldPassword($password);
        } else {
            return $this->___callPlugins('validateOldPassword', func_get_args(), $pluginInfo);
        }
    }
