<?php
namespace Silk\Cms\Block\Product;

/**
 * Interceptor class for @see \Silk\Cms\Block\Product
 */
class Interceptor extends \Silk\Cms\Block\Product implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\View\Element\Template\Context $context, \Magento\Catalog\Model\ProductFactory $productFactory, \Magento\Review\Model\ReviewFactory $reviewFactory, \Magento\Framework\Pricing\Helper\Data $priceHelper, \Magento\Framework\App\Cache $cache, array $data = array())
    {
        $this->___init();
        parent::__construct($context, $productFactory, $reviewFactory, $priceHelper, $cache, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getProductDataBySku');
        if (!$pluginInfo) {
            return parent::getProductDataBySku();
        } else {
            return $this->___callPlugins('getProductDataBySku', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getRatingSummary($product, $storeId)
    {
        ...
        if (!$pluginInfo) {
            return parent::getRatingSummary($product, $storeId);
        } else {
