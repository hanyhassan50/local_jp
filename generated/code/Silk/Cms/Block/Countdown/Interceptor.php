<?php
namespace Silk\Cms\Block\Countdown;

/**
 * Interceptor class for @see \Silk\Cms\Block\Countdown
 */
class Interceptor extends \Silk\Cms\Block\Countdown implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\View\Element\Template\Context $context, \Magento\Framework\App\Config\ScopeConfigInterface $scopeConfig, \Magento\Framework\Stdlib\DateTime\TimezoneInterface $date, array $data = array())
    {
        $this->___init();
        parent::__construct($context, $scopeConfig, $date, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTimerEnable');
        if (!$pluginInfo) {
            return parent::getTimerEnable();
        } else {
            return $this->___callPlugins('getTimerEnable', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTimerBeginDate');
        if (!$pluginInfo) {
            return parent::getTimerBeginDate();
        } else {
            return $this->___callPlugins('getTimerBeginDate', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTimerEndDate');
        if (!$pluginInfo) {
            return parent::getTimerEndDate();
        } else {
            return $this->___callPlugins('getTimerEndDate', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getLocaleTimezone');
        if (!$pluginInfo) {
            return parent::getLocaleTimezone();
        } else {
            return $this->___callPlugins('getLocaleTimezone', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTimerMessage');
        if (!$pluginInfo) {
            return parent::getTimerMessage();
        } else {
            return $this->___callPlugins('getTimerMessage', func_get_args(), $pluginInfo);
        }
    }
