<?php
namespace Silk\Catalog\Block\Product\ListProduct;

/**
 * Interceptor class for @see \Silk\Catalog\Block\Product\ListProduct
 */
class Interceptor extends \Silk\Catalog\Block\Product\ListProduct implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getProductTag');
        if (!$pluginInfo) {
            return parent::getProductTag($product_id);
        } else {
            return $this->___callPlugins('getProductTag', func_get_args(), $pluginInfo);
        }
    }
