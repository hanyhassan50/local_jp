...
class Interceptor extends \Apptrian\FacebookPixel\Block\Code implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Framework\View\Element\Template\Context $context, \Apptrian\FacebookPixel\Helper\Data $helper, \Magento\Framework\Registry $coreRegistry, \Magento\Catalog\Helper\Data $catalogHelper, \Magento\Tax\Model\Config $taxConfig, array $data = array())
    {
        $this->___init();
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getFacebookPixelData');
        if (!$pluginInfo) {
            return parent::getFacebookPixelData();
        } else {
            return $this->___callPlugins('getFacebookPixelData', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getDisplayTaxFlag');
        if (!$pluginInfo) {
            return parent::getDisplayTaxFlag();
        } else {
            return $this->___callPlugins('getDisplayTaxFlag', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCatalogTaxFlag');
        if (!$pluginInfo) {
            return parent::getCatalogTaxFlag();
        } else {
            return $this->___callPlugins('getCatalogTaxFlag', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getBundleProductPrice');
        if (!$pluginInfo) {
            return parent::getBundleProductPrice($product);
        } else {
            return $this->___callPlugins('getBundleProductPrice', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getConfigurableProductPrice');
        if (!$pluginInfo) {
            return parent::getConfigurableProductPrice($product);
        } else {
            return $this->___callPlugins('getConfigurableProductPrice', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getGroupedProductPrice');
        if (!$pluginInfo) {
            return parent::getGroupedProductPrice($product);
        } else {
            return $this->___callPlugins('getGroupedProductPrice', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getFinalPrice($product, $price = null)
    {
        ...
        if (!$pluginInfo) {
            return parent::getFinalPrice($product, $price);
        } else {
    ...
    public function formatPrice($price, $currencyCode = '')
    {
        ...
        if (!$pluginInfo) {
            return parent::formatPrice($price, $currencyCode);
        } else {
