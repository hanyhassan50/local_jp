<?php
namespace Ebizmarts\MailChimp\Block\Mailchimpjs;

/**
 * Interceptor class for @see \Ebizmarts\MailChimp\Block\Mailchimpjs
 */
class Interceptor extends \Ebizmarts\MailChimp\Block\Mailchimpjs implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\View\Element\Template\Context $context, \Ebizmarts\MailChimp\Helper\Data $helper, array $data)
    {
        $this->___init();
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getJsUrl');
        if (!$pluginInfo) {
            return parent::getJsUrl();
        } else {
            return $this->___callPlugins('getJsUrl', func_get_args(), $pluginInfo);
        }
    }
