...
class Interceptor extends \Magento\Captcha\Block\Captcha\DefaultCaptcha implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getRefreshUrl()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getRefreshUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getCaptchaModel()
    {
        ...
        if (!$pluginInfo) {
            return parent::getCaptchaModel();
        } else {
            return $this->___callPlugins('getCaptchaModel', func_get_args(), $pluginInfo);
        }
    }
