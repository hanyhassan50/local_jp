<?php
namespace Magento\VersionsCms\Block\Hierarchy\Pagination;

/**
 * Interceptor class for @see \Magento\VersionsCms\Block\Hierarchy\Pagination
 */
class Interceptor extends \Magento\VersionsCms\Block\Hierarchy\Pagination implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\View\Element\Template\Context $context, \Magento\Framework\Registry $registry, \Magento\VersionsCms\Model\Hierarchy\NodeFactory $nodeFactory, array $data = array(), \Magento\VersionsCms\Model\CurrentNodeResolverInterface $currentNodeResolver = null)
    {
        $this->___init();
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getUseNodeLabels');
        if (!$pluginInfo) {
            return parent::getUseNodeLabels();
        } else {
            return $this->___callPlugins('getUseNodeLabels', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'canShowSequence');
        if (!$pluginInfo) {
            return parent::canShowSequence();
        } else {
            return $this->___callPlugins('canShowSequence', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'canShowOuter');
        if (!$pluginInfo) {
            return parent::canShowOuter();
        } else {
            return $this->___callPlugins('canShowOuter', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getNodeLabel');
        if (!$pluginInfo) {
            return parent::getNodeLabel($node, $custom);
        } else {
            return $this->___callPlugins('getNodeLabel', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getFirstNode');
        if (!$pluginInfo) {
            return parent::getFirstNode();
        } else {
            return $this->___callPlugins('getFirstNode', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getLastNode');
        if (!$pluginInfo) {
            return parent::getLastNode();
        } else {
            return $this->___callPlugins('getLastNode', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'canShowPrevious');
        if (!$pluginInfo) {
            return parent::canShowPrevious();
        } else {
            return $this->___callPlugins('canShowPrevious', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getPreviousNode');
        if (!$pluginInfo) {
            return parent::getPreviousNode();
        } else {
            return $this->___callPlugins('getPreviousNode', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'canShowNext');
        if (!$pluginInfo) {
            return parent::canShowNext();
        } else {
            return $this->___callPlugins('canShowNext', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getNextNode');
        if (!$pluginInfo) {
            return parent::getNextNode();
        } else {
            return $this->___callPlugins('getNextNode', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getPreviousJumpNode');
        if (!$pluginInfo) {
            return parent::getPreviousJumpNode();
        } else {
            return $this->___callPlugins('getPreviousJumpNode', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getNextJumpNode');
        if (!$pluginInfo) {
            return parent::getNextJumpNode();
        } else {
            return $this->___callPlugins('getNextJumpNode', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isShowOutermost');
        if (!$pluginInfo) {
            return parent::isShowOutermost();
        } else {
            return $this->___callPlugins('isShowOutermost', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getNodes()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getNodes', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getNodesInRange');
        if (!$pluginInfo) {
            return parent::getNodesInRange();
        } else {
            return $this->___callPlugins('getNodesInRange', func_get_args(), $pluginInfo);
        }
    }
