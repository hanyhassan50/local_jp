...
class Interceptor extends \Magento\Weee\Pricing\Render\Adjustment implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getRawFinalAmount()
    {
        ...
        if (!$pluginInfo) {
            return parent::getRawFinalAmount();
        } else {
            return $this->___callPlugins('getRawFinalAmount', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getAdjustmentCode()
    {
        ...
        if (!$pluginInfo) {
            return parent::getAdjustmentCode();
        } else {
            return $this->___callPlugins('getAdjustmentCode', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getFinalAmount()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getFinalAmount', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function showInclDescr()
    {
        ...
        if (!$pluginInfo) {
            return parent::showInclDescr();
        } else {
            return $this->___callPlugins('showInclDescr', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function showExclDescrIncl()
    {
        ...
        if (!$pluginInfo) {
            return parent::showExclDescrIncl();
        } else {
            return $this->___callPlugins('showExclDescrIncl', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getWeeeTaxAttributes()
    {
        ...
        if (!$pluginInfo) {
            return parent::getWeeeTaxAttributes();
        } else {
            return $this->___callPlugins('getWeeeTaxAttributes', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function renderWeeeTaxAttributeName(\Magento\Framework\DataObject $attribute)
    {
        ...
        if (!$pluginInfo) {
            return parent::renderWeeeTaxAttributeName($attribute);
        } else {
            return $this->___callPlugins('renderWeeeTaxAttributeName', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function renderWeeeTaxAttribute(\Magento\Framework\DataObject $attribute)
    {
        ...
        if (!$pluginInfo) {
            return parent::renderWeeeTaxAttribute($attribute);
        } else {
            return $this->___callPlugins('renderWeeeTaxAttribute', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function renderWeeeTaxAttributeWithTax(\Magento\Framework\DataObject $attribute)
    {
        ...
        if (!$pluginInfo) {
            return parent::renderWeeeTaxAttributeWithTax($attribute);
        } else {
            return $this->___callPlugins('renderWeeeTaxAttributeWithTax', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function renderWeeeTaxAttributeWithoutTax(\Magento\Framework\DataObject $attribute)
    {
        ...
        if (!$pluginInfo) {
            return parent::renderWeeeTaxAttributeWithoutTax($attribute);
        } else {
            return $this->___callPlugins('renderWeeeTaxAttributeWithoutTax', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getTaxDisplayConfig()
    {
        ...
        if (!$pluginInfo) {
            return parent::getTaxDisplayConfig();
        } else {
            return $this->___callPlugins('getTaxDisplayConfig', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function isPriceIncludesTax()
    {
        ...
        if (!$pluginInfo) {
            return parent::isPriceIncludesTax();
        } else {
            return $this->___callPlugins('isPriceIncludesTax', func_get_args(), $pluginInfo);
        }
    }
     ...
     * {@inheritdoc}
     */
    public function render(\Magento\Framework\Pricing\Render\AmountRenderInterface $amountRender, array $arguments = array())
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'render');
        if (!$pluginInfo) {
            return parent::render($amountRender, $arguments);
        } else {
    ...
    public function getAmountRender()
    {
        ...
        if (!$pluginInfo) {
            return parent::getAmountRender();
        } else {
            return $this->___callPlugins('getAmountRender', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function convertAndFormatCurrency($amount, $includeContainer = true, $precision = 2)
    {
        ...
        if (!$pluginInfo) {
            return parent::convertAndFormatCurrency($amount, $includeContainer, $precision);
        } else {
            return $this->___callPlugins('convertAndFormatCurrency', func_get_args(), $pluginInfo);
        }
    }
