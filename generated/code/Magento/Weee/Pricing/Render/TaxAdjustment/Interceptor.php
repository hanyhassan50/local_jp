...
class Interceptor extends \Magento\Weee\Pricing\Render\TaxAdjustment implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getDefaultExclusions()
    {
        ...
        if (!$pluginInfo) {
            return parent::getDefaultExclusions();
        } else {
            return $this->___callPlugins('getDefaultExclusions', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getDisplayAmountExclTax($exclude = null, $includeContainer = false)
    {
        ...
        if (!$pluginInfo) {
            return parent::getDisplayAmountExclTax($exclude, $includeContainer);
        } else {
            return $this->___callPlugins('getDisplayAmountExclTax', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getRawAmount($exclude = null)
    {
        ...
        if (!$pluginInfo) {
            return parent::getRawAmount($exclude);
        } else {
            return $this->___callPlugins('getRawAmount', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getDisplayAmount($includeContainer = true)
    {
        ...
        if (!$pluginInfo) {
            return parent::getDisplayAmount($includeContainer);
        } else {
            return $this->___callPlugins('getDisplayAmount', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function buildIdWithPrefix($prefix)
    {
        ...
        if (!$pluginInfo) {
            return parent::buildIdWithPrefix($prefix);
        } else {
            return $this->___callPlugins('buildIdWithPrefix', func_get_args(), $pluginInfo);
        }
    }
