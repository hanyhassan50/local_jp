...
class Interceptor extends \Magento\Paypal\Block\Express\InContext\Minicart\Button implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getContainerId()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getContainerId', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getLinkAction');
        if (!$pluginInfo) {
            return parent::getLinkAction();
        } else {
            return $this->___callPlugins('getLinkAction', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAddToCartSelector');
        if (!$pluginInfo) {
            return parent::getAddToCartSelector();
        } else {
            return $this->___callPlugins('getAddToCartSelector', func_get_args(), $pluginInfo);
        }
    }
