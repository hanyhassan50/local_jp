...
class Interceptor extends \Magento\Paypal\Block\Express\Shortcut implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isOrPositionBefore');
        if (!$pluginInfo) {
            return parent::isOrPositionBefore();
        } else {
            return $this->___callPlugins('isOrPositionBefore', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isOrPositionAfter');
        if (!$pluginInfo) {
            return parent::isOrPositionAfter();
        } else {
            return $this->___callPlugins('isOrPositionAfter', func_get_args(), $pluginInfo);
        }
    }
