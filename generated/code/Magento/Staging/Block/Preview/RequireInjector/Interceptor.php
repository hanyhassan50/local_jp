<?php
namespace Magento\Staging\Block\Preview\RequireInjector;

/**
 * Interceptor class for @see \Magento\Staging\Block\Preview\RequireInjector
 */
class Interceptor extends \Magento\Staging\Block\Preview\RequireInjector implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\View\Element\Template\Context $context, \Magento\Staging\Model\VersionManager $versionManager, array $data = array())
    {
        $this->___init();
        parent::__construct($context, $versionManager, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getRequireModuleName');
        if (!$pluginInfo) {
            return parent::getRequireModuleName();
        } else {
            return $this->___callPlugins('getRequireModuleName', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getInjectionsList');
        if (!$pluginInfo) {
            return parent::getInjectionsList();
        } else {
            return $this->___callPlugins('getInjectionsList', func_get_args(), $pluginInfo);
        }
    }
