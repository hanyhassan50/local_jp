<?php
namespace Magento\Staging\Block\Preview\LinkStub;

/**
 * Interceptor class for @see \Magento\Staging\Block\Preview\LinkStub
 */
class Interceptor extends \Magento\Staging\Block\Preview\LinkStub implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\View\Element\Template\Context $context, \Magento\Framework\App\DefaultPathInterface $defaultPath, \Magento\Staging\Model\VersionManager $versionManager, array $data = array())
    {
        $this->___init();
        parent::__construct($context, $defaultPath, $versionManager, $data);
    }
