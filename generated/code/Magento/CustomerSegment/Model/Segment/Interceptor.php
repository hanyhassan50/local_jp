...
class Interceptor extends \Magento\CustomerSegment\Model\Segment implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'collectMatchedEvents');
        if (!$pluginInfo) {
            return parent::collectMatchedEvents($conditionsCombine);
        } else {
            return $this->___callPlugins('collectMatchedEvents', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getConditionModels');
        if (!$pluginInfo) {
            return parent::getConditionModels($conditions);
        } else {
            return $this->___callPlugins('getConditionModels', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'validateCustomer');
        if (!$pluginInfo) {
            return parent::validateCustomer($customer, $website);
        } else {
            return $this->___callPlugins('validateCustomer', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'matchCustomers');
        if (!$pluginInfo) {
            return parent::matchCustomers();
        } else {
            return $this->___callPlugins('matchCustomers', func_get_args(), $pluginInfo);
        }
    }
