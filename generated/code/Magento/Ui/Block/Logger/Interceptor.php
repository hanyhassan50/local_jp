...
class Interceptor extends \Magento\Ui\Block\Logger implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function isLoggingEnabled()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('isLoggingEnabled', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getSessionStorageKey()
    {
        ...
        if (!$pluginInfo) {
            return parent::getSessionStorageKey();
        } else {
            return $this->___callPlugins('getSessionStorageKey', func_get_args(), $pluginInfo);
        }
    }
