<?php
namespace Magento\GoogleTagManager\Block\Ga;

/**
 * Interceptor class for @see \Magento\GoogleTagManager\Block\Ga
 */
class Interceptor extends \Magento\GoogleTagManager\Block\Ga implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\View\Element\Template\Context $context, \Magento\Sales\Model\ResourceModel\Order\CollectionFactory $salesOrderCollection, \Magento\GoogleTagManager\Helper\Data $googleAnalyticsData, \Magento\Cookie\Helper\Cookie $cookieHelper, \Magento\Framework\Json\Helper\Data $jsonHelper, array $data = array())
    {
        $this->___init();
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getOrdersData');
        if (!$pluginInfo) {
            return parent::getOrdersData();
        } else {
            return $this->___callPlugins('getOrdersData', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getOrdersDataArray');
        if (!$pluginInfo) {
            return parent::getOrdersDataArray();
        } else {
            return $this->___callPlugins('getOrdersDataArray', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getPageName()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getPageName', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getPageTrackingCode($accountId)
    {
        ...
        if (!$pluginInfo) {
            return parent::getPageTrackingCode($accountId);
        } else {
            return $this->___callPlugins('getPageTrackingCode', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getOrdersTrackingCode()
    {
        ...
        if (!$pluginInfo) {
            return parent::getOrdersTrackingCode();
        } else {
            return $this->___callPlugins('getOrdersTrackingCode', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getPageTrackingData($accountId)
    {
        ...
        if (!$pluginInfo) {
            return parent::getPageTrackingData($accountId);
        } else {
            return $this->___callPlugins('getPageTrackingData', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getOrdersTrackingData()
    {
        ...
        if (!$pluginInfo) {
            return parent::getOrdersTrackingData();
        } else {
            return $this->___callPlugins('getOrdersTrackingData', func_get_args(), $pluginInfo);
        }
    }
