<?php
namespace Magento\GoogleTagManager\Block\ListJson;

/**
 * Interceptor class for @see \Magento\GoogleTagManager\Block\ListJson
 */
class Interceptor extends \Magento\GoogleTagManager\Block\ListJson implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\View\Element\Template\Context $context, \Magento\GoogleTagManager\Helper\Data $helper, \Magento\Framework\Json\Helper\Data $jsonHelper, \Magento\Framework\Registry $registry, \Magento\Checkout\Model\Session $checkoutSession, \Magento\Customer\Model\Session $customerSession, \Magento\Checkout\Helper\Cart $checkoutCart, \Magento\Catalog\Model\Layer\Resolver $layerResolver, \Magento\Framework\Module\Manager $moduleManager, \Magento\Framework\App\Request\Http $request, \Magento\Banner\Model\ResourceModel\Banner\CollectionFactory $bannerColFactory, \Magento\GoogleTagManager\Model\Banner\Collector $bannerCollector, array $data = array())
    {
        $this->___init();
    ...
    public function getListBlock()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getListBlock', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'checkCartItems');
        if (!$pluginInfo) {
            return parent::checkCartItems();
        } else {
            return $this->___callPlugins('checkCartItems', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCurrentCategoryName');
        if (!$pluginInfo) {
            return parent::getCurrentCategoryName();
        } else {
            return $this->___callPlugins('getCurrentCategoryName', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCurrentListName');
        if (!$pluginInfo) {
            return parent::getCurrentListName();
        } else {
            return $this->___callPlugins('getCurrentListName', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'appendBannerBlock');
        if (!$pluginInfo) {
            return parent::appendBannerBlock($block);
        } else {
            return $this->___callPlugins('appendBannerBlock', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getBannerCollection()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getBannerCollection', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getBannerPosition');
        if (!$pluginInfo) {
            return parent::getBannerPosition();
        } else {
            return $this->___callPlugins('getBannerPosition', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'detectStepName');
        if (!$pluginInfo) {
            return parent::detectStepName();
        } else {
            return $this->___callPlugins('detectStepName', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCartContent');
        if (!$pluginInfo) {
            return parent::getCartContent();
        } else {
            return $this->___callPlugins('getCartContent', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCartContentForUpdate');
        if (!$pluginInfo) {
            return parent::getCartContentForUpdate();
        } else {
            return $this->___callPlugins('getCartContentForUpdate', func_get_args(), $pluginInfo);
        }
    }
