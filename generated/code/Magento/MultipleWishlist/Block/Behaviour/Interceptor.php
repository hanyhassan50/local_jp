<?php
namespace Magento\MultipleWishlist\Block\Behaviour;

/**
 * Interceptor class for @see \Magento\MultipleWishlist\Block\Behaviour
 */
class Interceptor extends \Magento\MultipleWishlist\Block\Behaviour implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\View\Element\Template\Context $context, \Magento\MultipleWishlist\Helper\Data $wishlistData, array $data = array())
    {
        $this->___init();
        parent::__construct($context, $wishlistData, $data);
    }
