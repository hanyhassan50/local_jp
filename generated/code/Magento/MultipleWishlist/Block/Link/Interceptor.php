<?php
namespace Magento\MultipleWishlist\Block\Link;

/**
 * Interceptor class for @see \Magento\MultipleWishlist\Block\Link
 */
class Interceptor extends \Magento\MultipleWishlist\Block\Link implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\View\Element\Template\Context $context, \Magento\Wishlist\Helper\Data $wishlistHelper, \Magento\MultipleWishlist\Helper\Data $wishlistData, array $data = array())
    {
        $this->___init();
        parent::__construct($context, $wishlistHelper, $wishlistData, $data);
    }
