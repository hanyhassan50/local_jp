...
class Interceptor extends \Magento\Framework\Pricing\Render\Amount implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function setDisplayValue($value)
    {
        ...
        if (!$pluginInfo) {
            return parent::setDisplayValue($value);
        } else {
            return $this->___callPlugins('setDisplayValue', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getDisplayValue()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getDisplayValue', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getDisplayCurrencyCode()
    {
        ...
        if (!$pluginInfo) {
            return parent::getDisplayCurrencyCode();
        } else {
            return $this->___callPlugins('getDisplayCurrencyCode', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getDisplayCurrencySymbol()
    {
        ...
        if (!$pluginInfo) {
            return parent::getDisplayCurrencySymbol();
        } else {
            return $this->___callPlugins('getDisplayCurrencySymbol', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function hasAdjustmentsHtml()
    {
        ...
        if (!$pluginInfo) {
            return parent::hasAdjustmentsHtml();
        } else {
            return $this->___callPlugins('hasAdjustmentsHtml', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getAdjustmentsHtml()
    {
        ...
        if (!$pluginInfo) {
            return parent::getAdjustmentsHtml();
        } else {
            return $this->___callPlugins('getAdjustmentsHtml', func_get_args(), $pluginInfo);
        }
    }
