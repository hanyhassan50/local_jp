<?php
namespace Magento\Invitation\Block\Link;

/**
 * Interceptor class for @see \Magento\Invitation\Block\Link
 */
class Interceptor extends \Magento\Invitation\Block\Link implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\View\Element\Template\Context $context, \Magento\Framework\App\Http\Context $httpContext, \Magento\Invitation\Helper\Data $invitationHelper, \Magento\Invitation\Model\Config $invitationConfiguration, array $data = array())
    {
        $this->___init();
        parent::__construct($context, $httpContext, $invitationHelper, $invitationConfiguration, $data);
    }
