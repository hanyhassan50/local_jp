...
class Interceptor extends \Magento\Catalog\Block\Category\Rss\Link implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isRssAllowed');
        if (!$pluginInfo) {
            return parent::isRssAllowed();
        } else {
            return $this->___callPlugins('isRssAllowed', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isTopCategory');
        if (!$pluginInfo) {
            return parent::isTopCategory();
        } else {
            return $this->___callPlugins('isTopCategory', func_get_args(), $pluginInfo);
        }
    }
