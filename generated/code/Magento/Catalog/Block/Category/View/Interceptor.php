...
class Interceptor extends \Magento\Catalog\Block\Category\View implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getCmsBlockHtml()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getCmsBlockHtml', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function isProductMode()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('isProductMode', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function isContentMode()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('isContentMode', func_get_args(), $pluginInfo);
        }
    }
