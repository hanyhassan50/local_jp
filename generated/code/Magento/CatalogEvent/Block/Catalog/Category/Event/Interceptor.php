<?php
namespace Magento\CatalogEvent\Block\Catalog\Category\Event;

/**
 * Interceptor class for @see \Magento\CatalogEvent\Block\Catalog\Category\Event
 */
class Interceptor extends \Magento\CatalogEvent\Block\Catalog\Category\Event implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\View\Element\Template\Context $context, \Magento\CatalogEvent\Model\DateResolver $dateResolver, \Magento\Framework\Registry $registry, \Magento\CatalogEvent\Helper\Data $catalogEventData, array $data = array())
    {
        $this->___init();
        parent::__construct($context, $dateResolver, $registry, $catalogEventData, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getStatusText');
        if (!$pluginInfo) {
            return parent::getStatusText($event);
        } else {
            return $this->___callPlugins('getStatusText', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getEventTime');
        if (!$pluginInfo) {
            return parent::getEventTime($type, $event);
        } else {
            return $this->___callPlugins('getEventTime', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getEventDate');
        if (!$pluginInfo) {
            return parent::getEventDate($type, $event);
        } else {
            return $this->___callPlugins('getEventDate', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getEventDateTime');
        if (!$pluginInfo) {
            return parent::getEventDateTime($type, $event);
        } else {
            return $this->___callPlugins('getEventDateTime', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSecondsToClose');
        if (!$pluginInfo) {
            return parent::getSecondsToClose($event);
        } else {
            return $this->___callPlugins('getSecondsToClose', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getEndTimeUTC');
        if (!$pluginInfo) {
            return parent::getEndTimeUTC($event);
        } else {
            return $this->___callPlugins('getEndTimeUTC', func_get_args(), $pluginInfo);
        }
    }
