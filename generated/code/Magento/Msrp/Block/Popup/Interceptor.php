...
class Interceptor extends \Magento\Msrp\Block\Popup implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getExplanationMessage()
    {
        ...
        if (!$pluginInfo) {
            return parent::getExplanationMessage();
        } else {
            return $this->___callPlugins('getExplanationMessage', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getExplanationMessageWhatsThis()
    {
        ...
        if (!$pluginInfo) {
            return parent::getExplanationMessageWhatsThis();
        } else {
            return $this->___callPlugins('getExplanationMessageWhatsThis', func_get_args(), $pluginInfo);
        }
    }
