...
class Interceptor extends \Magento\Customer\Block\CustomerData implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getCustomerDataUrl($route)
    {
        ...
        if (!$pluginInfo) {
            return parent::getCustomerDataUrl($route);
        } else {
            return $this->___callPlugins('getCustomerDataUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getExpirableSectionLifetime()
    {
        ...
        if (!$pluginInfo) {
            return parent::getExpirableSectionLifetime();
        } else {
            return $this->___callPlugins('getExpirableSectionLifetime', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getExpirableSectionNames()
    {
        ...
        if (!$pluginInfo) {
            return parent::getExpirableSectionNames();
        } else {
            return $this->___callPlugins('getExpirableSectionNames', func_get_args(), $pluginInfo);
        }
    }
