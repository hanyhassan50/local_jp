...
class Interceptor extends \Magento\Customer\Block\Widget\Name implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'showPrefix');
        if (!$pluginInfo) {
            return parent::showPrefix();
        } else {
            return $this->___callPlugins('showPrefix', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isPrefixRequired');
        if (!$pluginInfo) {
            return parent::isPrefixRequired();
        } else {
            return $this->___callPlugins('isPrefixRequired', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'showMiddlename');
        if (!$pluginInfo) {
            return parent::showMiddlename();
        } else {
            return $this->___callPlugins('showMiddlename', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isMiddlenameRequired');
        if (!$pluginInfo) {
            return parent::isMiddlenameRequired();
        } else {
            return $this->___callPlugins('isMiddlenameRequired', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'showSuffix');
        if (!$pluginInfo) {
            return parent::showSuffix();
        } else {
            return $this->___callPlugins('showSuffix', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isSuffixRequired');
        if (!$pluginInfo) {
            return parent::isSuffixRequired();
        } else {
            return $this->___callPlugins('isSuffixRequired', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getClassName');
        if (!$pluginInfo) {
            return parent::getClassName();
        } else {
            return $this->___callPlugins('getClassName', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getContainerClassName');
        if (!$pluginInfo) {
            return parent::getContainerClassName();
        } else {
            return $this->___callPlugins('getContainerClassName', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAttributeValidationClass');
        if (!$pluginInfo) {
            return parent::getAttributeValidationClass($attributeCode);
        } else {
            return $this->___callPlugins('getAttributeValidationClass', func_get_args(), $pluginInfo);
        }
    }
