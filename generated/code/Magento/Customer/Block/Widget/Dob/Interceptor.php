...
class Interceptor extends \Magento\Customer\Block\Widget\Dob implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getDay');
        if (!$pluginInfo) {
            return parent::getDay();
        } else {
            return $this->___callPlugins('getDay', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getMonth');
        if (!$pluginInfo) {
            return parent::getMonth();
        } else {
            return $this->___callPlugins('getMonth', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getYear');
        if (!$pluginInfo) {
            return parent::getYear();
        } else {
            return $this->___callPlugins('getYear', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getFieldHtml');
        if (!$pluginInfo) {
            return parent::getFieldHtml();
        } else {
            return $this->___callPlugins('getFieldHtml', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getHtmlExtraParams');
        if (!$pluginInfo) {
            return parent::getHtmlExtraParams();
        } else {
            return $this->___callPlugins('getHtmlExtraParams', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setDateInput');
        if (!$pluginInfo) {
            return parent::setDateInput($code, $html);
        } else {
            return $this->___callPlugins('setDateInput', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSortedDateInputs');
        if (!$pluginInfo) {
            return parent::getSortedDateInputs($stripNonInputChars);
        } else {
            return $this->___callPlugins('getSortedDateInputs', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getMinDateRange');
        if (!$pluginInfo) {
            return parent::getMinDateRange();
        } else {
            return $this->___callPlugins('getMinDateRange', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getMaxDateRange');
        if (!$pluginInfo) {
            return parent::getMaxDateRange();
        } else {
            return $this->___callPlugins('getMaxDateRange', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getFirstDay');
        if (!$pluginInfo) {
            return parent::getFirstDay();
        } else {
            return $this->___callPlugins('getFirstDay', func_get_args(), $pluginInfo);
        }
    }
