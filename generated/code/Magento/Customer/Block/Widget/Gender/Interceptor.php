...
class Interceptor extends \Magento\Customer\Block\Widget\Gender implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getGenderOptions');
        if (!$pluginInfo) {
            return parent::getGenderOptions();
        } else {
            return $this->___callPlugins('getGenderOptions', func_get_args(), $pluginInfo);
        }
    }
