...
class Interceptor extends \Magento\Theme\Block\Html\Notices implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function displayNoscriptNotice()
    {
        ...
        if (!$pluginInfo) {
            return parent::displayNoscriptNotice();
        } else {
            return $this->___callPlugins('displayNoscriptNotice', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function displayNoLocalStorageNotice()
    {
        ...
        if (!$pluginInfo) {
            return parent::displayNoLocalStorageNotice();
        } else {
            return $this->___callPlugins('displayNoLocalStorageNotice', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function displayDemoNotice()
    {
        ...
        if (!$pluginInfo) {
            return parent::displayDemoNotice();
        } else {
            return $this->___callPlugins('displayDemoNotice', func_get_args(), $pluginInfo);
        }
    }
