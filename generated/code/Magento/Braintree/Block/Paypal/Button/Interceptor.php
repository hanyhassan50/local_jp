...
class Interceptor extends \Magento\Braintree\Block\Paypal\Button implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getMerchantName()
    {
        ...
        if (!$pluginInfo) {
            return parent::getMerchantName();
        } else {
            return $this->___callPlugins('getMerchantName', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getActionSuccess()
    {
        ...
        if (!$pluginInfo) {
            return parent::getActionSuccess();
        } else {
            return $this->___callPlugins('getActionSuccess', func_get_args(), $pluginInfo);
        }
    }
