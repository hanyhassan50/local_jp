...
class Interceptor extends \Magento\Translation\Block\Js implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function dictionaryEnabled()
    {
        ...
        if (!$pluginInfo) {
            return parent::dictionaryEnabled();
        } else {
            return $this->___callPlugins('dictionaryEnabled', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getTranslationFileTimestamp()
    {
        ...
        if (!$pluginInfo) {
            return parent::getTranslationFileTimestamp();
        } else {
            return $this->___callPlugins('getTranslationFileTimestamp', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getTranslationFilePath()
    {
        ...
        if (!$pluginInfo) {
            return parent::getTranslationFilePath();
        } else {
            return $this->___callPlugins('getTranslationFilePath', func_get_args(), $pluginInfo);
        }
    }
