<?php
namespace Bss\TimeCountdown\Block\Catalog\TimerBlock;

/**
 * Interceptor class for @see \Bss\TimeCountdown\Block\Catalog\TimerBlock
 */
class Interceptor extends \Bss\TimeCountdown\Block\Catalog\TimerBlock implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setTimerTemplate');
        if (!$pluginInfo) {
            return parent::setTimerTemplate($type);
        } else {
            return $this->___callPlugins('setTimerTemplate', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getEnableCatalog');
        if (!$pluginInfo) {
            return parent::getEnableCatalog();
        } else {
            return $this->___callPlugins('getEnableCatalog', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTimerCatalogId');
        if (!$pluginInfo) {
            return parent::getTimerCatalogId();
        } else {
            return $this->___callPlugins('getTimerCatalogId', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isProductInCatalog');
        if (!$pluginInfo) {
            return parent::isProductInCatalog($productId);
        } else {
            return $this->___callPlugins('isProductInCatalog', func_get_args(), $pluginInfo);
        }
    }
