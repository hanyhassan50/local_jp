<?php
namespace Anowave\Ec\Block\Track;

/**
 * Interceptor class for @see \Anowave\Ec\Block\Track
 */
class Interceptor extends \Anowave\Ec\Block\Track implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\View\Element\Template\Context $context, \Anowave\Ec\Helper\Data $helper, \Anowave\Ec\Helper\Datalayer $dataLayer, \Anowave\Ec\Model\Api\Measurement\Protocol $protocol, array $data = array())
    {
        $this->___init();
        parent::__construct($context, $helper, $dataLayer, $protocol, $data);
    }
    ...
    public function getSalesOrderCollection()
    {
        ...
        if (!$pluginInfo) {
            return parent::getSalesOrderCollection();
        } else {
            return $this->___callPlugins('getSalesOrderCollection', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getPageType()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getPageType', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getPurchasePush');
        if (!$pluginInfo) {
            return parent::getPurchasePush();
        } else {
            return $this->___callPlugins('getPurchasePush', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getPurchaseGoogleTagParams()
    {
        ...
        if (!$pluginInfo) {
            return parent::getPurchaseGoogleTagParams();
        } else {
            return $this->___callPlugins('getPurchaseGoogleTagParams', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getVisitorPush()
    {
        ...
        if (!$pluginInfo) {
            return parent::getVisitorPush();
        } else {
            return $this->___callPlugins('getVisitorPush', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getDetailPushForward()
    {
        ...
        if (!$pluginInfo) {
            return parent::getDetailPushForward();
        } else {
            return $this->___callPlugins('getDetailPushForward', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getImpressionPushForward');
        if (!$pluginInfo) {
            return parent::getImpressionPushForward();
        } else {
            return $this->___callPlugins('getImpressionPushForward', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSearchPush');
        if (!$pluginInfo) {
            return parent::getSearchPush();
        } else {
            return $this->___callPlugins('getSearchPush', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getConversion');
        if (!$pluginInfo) {
            return parent::getConversion();
        } else {
            return $this->___callPlugins('getConversion', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getBodySnippet()
    {
        ...
        if (!$pluginInfo) {
            return parent::getBodySnippet();
        } else {
            return $this->___callPlugins('getBodySnippet', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getHeadSnippet()
    {
        ...
        if (!$pluginInfo) {
            return parent::getHeadSnippet();
        } else {
            return $this->___callPlugins('getHeadSnippet', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'afterBody');
        if (!$pluginInfo) {
            return parent::afterBody();
        } else {
            return $this->___callPlugins('afterBody', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAdWords');
        if (!$pluginInfo) {
            return parent::getAdWords();
        } else {
            return $this->___callPlugins('getAdWords', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getRevenue()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getRevenue', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getDatalayer');
        if (!$pluginInfo) {
            return parent::getDatalayer();
        } else {
            return $this->___callPlugins('getDatalayer', func_get_args(), $pluginInfo);
        }
    }
