<?php
namespace Magestore\Bannerslider\Block\SliderItem;

/**
 * Interceptor class for @see \Magestore\Bannerslider\Block\SliderItem
 */
class Interceptor extends \Magestore\Bannerslider\Block\SliderItem implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\View\Element\Template\Context $context, \Magestore\Bannerslider\Model\ResourceModel\Banner\Collection $bannerCollectionFactory, \Magestore\Bannerslider\Model\SliderFactory $sliderFactory, \Magestore\Bannerslider\Model\Slider $slider, \Magento\Framework\Stdlib\DateTime\DateTime $stdlibDateTime, \Magestore\Bannerslider\Helper\Data $bannersliderHelper, \Magento\Framework\Stdlib\DateTime\Timezone $_stdTimezone, array $data = array())
    {
        $this->___init();
        parent::__construct($context, $bannerCollectionFactory, $sliderFactory, $slider, $stdlibDateTime, $bannersliderHelper, $_stdTimezone, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setStyleSlideTemplate');
        if (!$pluginInfo) {
            return parent::setStyleSlideTemplate($styleSlideId);
        } else {
            return $this->___callPlugins('setStyleSlideTemplate', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isShowTitle');
        if (!$pluginInfo) {
            return parent::isShowTitle();
        } else {
            return $this->___callPlugins('isShowTitle', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getFirstBannerItem');
        if (!$pluginInfo) {
            return parent::getFirstBannerItem();
        } else {
            return $this->___callPlugins('getFirstBannerItem', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getPositionNote');
        if (!$pluginInfo) {
            return parent::getPositionNote();
        } else {
            return $this->___callPlugins('getPositionNote', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getFlexsliderHtmlId');
        if (!$pluginInfo) {
            return parent::getFlexsliderHtmlId();
        } else {
            return $this->___callPlugins('getFlexsliderHtmlId', func_get_args(), $pluginInfo);
        }
    }
