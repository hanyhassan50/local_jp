...
/**
 * Interceptor class for @see \Amasty\Feed\Model\Rule
 */
class Interceptor extends \Amasty\Feed\Model\Rule implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getFeedMatchingProductIds');
        if (!$pluginInfo) {
            return parent::getFeedMatchingProductIds();
        } else {
            return $this->___callPlugins('getFeedMatchingProductIds', func_get_args(), $pluginInfo);
        }
    }
