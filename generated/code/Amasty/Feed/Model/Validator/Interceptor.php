<?php
namespace Amasty\Feed\Model\Validator;

/**
 * Interceptor class for @see \Amasty\Feed\Model\Validator
 */
class Interceptor extends \Amasty\Feed\Model\Validator implements \Magento\Framework\Interception\InterceptorInterface
{
     ...
     * {@inheritdoc}
     */
    public function getValidProducts(\Amasty\Feed\Model\Feed $model, $page, $itemsPerPage, array $ids = array())
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getValidProducts');
        if (!$pluginInfo) {
            return parent::getValidProducts($model, $page, $itemsPerPage, $ids);
        } else {
            return $this->___callPlugins('getValidProducts', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'validateProduct');
        if (!$pluginInfo) {
            return parent::validateProduct($model, $product);
        } else {
            return $this->___callPlugins('validateProduct', func_get_args(), $pluginInfo);
        }
    }
