...
class Interceptor extends \Mageplaza\GoogleRecaptcha\Block\Captcha implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Framework\View\Element\Template\Context $context, \Mageplaza\GoogleRecaptcha\Helper\Data $helperData, array $data = array())
    {
        $this->___init();
    ...
    public function getForms()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getForms', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function unsetDataFromId($item, $text)
    {
        ...
        if (!$pluginInfo) {
            return parent::unsetDataFromId($item, $text);
        } else {
            return $this->___callPlugins('unsetDataFromId', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getInvisibleKey()
    {
        ...
        if (!$pluginInfo) {
            return parent::getInvisibleKey();
        } else {
            return $this->___callPlugins('getInvisibleKey', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getPositionFrontend()
    {
        ...
        if (!$pluginInfo) {
            return parent::getPositionFrontend();
        } else {
            return $this->___callPlugins('getPositionFrontend', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function isCaptchaFrontend()
    {
        ...
        if (!$pluginInfo) {
            return parent::isCaptchaFrontend();
        } else {
            return $this->___callPlugins('isCaptchaFrontend', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getLanguageCode()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getLanguageCode', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getThemeFrontend()
    {
        ...
        if (!$pluginInfo) {
            return parent::getThemeFrontend();
        } else {
            return $this->___callPlugins('getThemeFrontend', func_get_args(), $pluginInfo);
        }
    }
