...
class Interceptor extends \Mageplaza\SocialLogin\Block\Popup\Social implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Framework\View\Element\Template\Context $context, \Mageplaza\SocialLogin\Helper\Social $socialHelper, array $data = array())
    {
        $this->___init();
    ...
    public function getAvailableSocials()
    {
        ...
        if (!$pluginInfo) {
            return parent::getAvailableSocials();
        } else {
            return $this->___callPlugins('getAvailableSocials', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getBtnKey($key)
    {
        ...
        if (!$pluginInfo) {
            return parent::getBtnKey($key);
        } else {
            return $this->___callPlugins('getBtnKey', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getSocialButtonsConfig()
    {
        ...
        if (!$pluginInfo) {
            return parent::getSocialButtonsConfig();
        } else {
            return $this->___callPlugins('getSocialButtonsConfig', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function canShow($position = null)
    {
        ...
        if (!$pluginInfo) {
            return parent::canShow($position);
        } else {
     ...
     * {@inheritdoc}
     */
    public function getLoginUrl($socialKey, $params = array())
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getLoginUrl');
        if (!$pluginInfo) {
            return parent::getLoginUrl($socialKey, $params);
        } else {
