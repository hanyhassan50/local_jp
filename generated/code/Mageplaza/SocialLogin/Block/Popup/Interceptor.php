...
class Interceptor extends \Mageplaza\SocialLogin\Block\Popup implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Framework\View\Element\Template\Context $context, \Mageplaza\SocialLogin\Helper\Data $helperData, \Magento\Customer\Model\Session $customerSession, array $data = array())
    {
        $this->___init();
    ...
    public function getFormParams()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getFormParams', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getHeaderLink()
    {
        ...
        if (!$pluginInfo) {
            return parent::getHeaderLink();
        } else {
            return $this->___callPlugins('getHeaderLink', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getPopupEffect()
    {
        ...
        if (!$pluginInfo) {
            return parent::getPopupEffect();
        } else {
            return $this->___callPlugins('getPopupEffect', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getFormLoginUrl()
    {
        ...
        if (!$pluginInfo) {
            return parent::getFormLoginUrl();
        } else {
            return $this->___callPlugins('getFormLoginUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getFakeEmailUrl()
    {
        ...
        if (!$pluginInfo) {
            return parent::getFakeEmailUrl();
        } else {
            return $this->___callPlugins('getFakeEmailUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getForgotFormUrl()
    {
        ...
        if (!$pluginInfo) {
            return parent::getForgotFormUrl();
        } else {
            return $this->___callPlugins('getForgotFormUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getCreateFormUrl()
    {
        ...
        if (!$pluginInfo) {
            return parent::getCreateFormUrl();
        } else {
            return $this->___callPlugins('getCreateFormUrl', func_get_args(), $pluginInfo);
        }
    }
