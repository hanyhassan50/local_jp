...
class Interceptor extends \Mageplaza\SocialLogin\Block\Form\Login implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getForgotPasswordUrl()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getForgotPasswordUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function isAutocompleteDisabled()
    {
        ...
        if (!$pluginInfo) {
            return parent::isAutocompleteDisabled();
        } else {
            return $this->___callPlugins('isAutocompleteDisabled', func_get_args(), $pluginInfo);
        }
    }
