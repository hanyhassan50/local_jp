<?php
namespace Mageplaza\Affiliate\Block\Js\Hash;

/**
 * Interceptor class for @see \Mageplaza\Affiliate\Block\Js\Hash
 */
class Interceptor extends \Mageplaza\Affiliate\Block\Js\Hash implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\View\Element\Template\Context $context, \Mageplaza\Affiliate\Helper\Data $affiliateHelper, array $data = array())
    {
        $this->___init();
        parent::__construct($context, $affiliateHelper, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCookieName');
        if (!$pluginInfo) {
            return parent::getCookieName();
        } else {
            return $this->___callPlugins('getCookieName', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'checkCookie');
        if (!$pluginInfo) {
            return parent::checkCookie();
        } else {
            return $this->___callPlugins('checkCookie', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getExpire');
        if (!$pluginInfo) {
            return parent::getExpire();
        } else {
            return $this->___callPlugins('getExpire', func_get_args(), $pluginInfo);
        }
    }
